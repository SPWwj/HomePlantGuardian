...
# WARNING: THIS FILE IS VERSION 2 OF THE ORIGINAL, FOR DEMO PURPOSES ONLY
...
# New Version for demo (dumbed down for easy display)
# riskFactor = k, k = (roll/180 + pitch/90)/2
...
def calculate_riskfactor(event, roll, pitch, timestamp):
    ...
    devices_table.update_item(
        ...
        ExpressionAttributeValues={
            ':v1': decimal.Decimal(repr(risk_factor)),
            ':v2': timestamp
        }
    )
